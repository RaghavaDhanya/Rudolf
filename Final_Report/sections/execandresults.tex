...
\begin{figure}[H]
    \centering
    \subfloat[Classical ACGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/acgan.png} }}%
    \qquad
    \subfloat[CapsNet augmented ACGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/acgan_caps.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[Classical DCGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/dcgan.png} }}%
    \qquad
    \subfloat[CapsNet augmented DCGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/dcgan_caps.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[Classical InfoGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/infogan.png} }}%
    \qquad
    \subfloat[CapsNet augmented InfoGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/infogan_caps.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[Classical WGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/wgan.png} }}%
    \qquad
    \subfloat[CapsNet augmented WGAN]{{\includegraphics[width=.46\linewidth]{images/generation_outputs/wgan_caps.png} }}%
...
\begin{figure}[H]
    ...
    \\
    \centering
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/6.png} }}%
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/7.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/5_2.png} }}%
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/5_6.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/1.png} }}%
    \subfloat{{\includegraphics[width=.49\linewidth]{images/completion_outputs/2.png} }}%
    \\
    \centering
