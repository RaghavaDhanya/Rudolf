...
\begin{figure}[H]
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/0_1.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/0_2.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/3_1.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/3_2.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/4.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/8_1.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/9_1.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_10.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_11.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_12.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_13.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_14.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_15.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_16.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_17.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_18.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_19.png} }}%
    \\
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/completion_outputs/Figure_20.png} }}%
